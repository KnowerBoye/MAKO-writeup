...
\end{center}
\caption{Recent trends in LLM-based multi-agent research for problem solving and world simulation are categorized and tracked by paper counts every three months, with each leaf node showing the number of papers in that category adapted from \citet{guo2024largelanguagemodelbased}}
\label{trend}
\end{figure*}
